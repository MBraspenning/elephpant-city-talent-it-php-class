...
class BlogController extends Controller
{
     ...
     *
     * @Route("/new/calendar", name="admin_new_calender")
     * @Method({"GET", "POST"})
     *
    ...
    public function newCalendar(Request $request)
    {
        ...
        $form = $this->createForm(CalenderType::class, $calendar)
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'calendar.created_successfully');

            if ($form->get('saveAndCreateNew')->isClicked()) {
                return $this->redirectToRoute('admin_new_calender');
            }
